...
export const users = pgTable(
    "users",
    {
        ...
        phoneVerificationExpiresAt: timestamp("phone_verification_expires_at", { mode: "date" }),
        phoneVerificationRequestedAt: timestamp("phone_verification_requested_at", { mode: "date" }),
